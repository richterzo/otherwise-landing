          ...
          >
            ...
            <div className="space-y-6 mb-12">
              <motion.div
                ...
                whileHover={{ x: 5 }}
              >
                <div className="w-12 h-12 border border-arancione-brand flex items-center justify-center text-arancione-brand flex-shrink-0 opacity-80 hover:opacity-100 transition-opacity">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" aria-label="Form di contatto">
              <div>
                ...
                <motion.input
                  ...
                  required
                  className="w-full px-4 py-3 bg-nero-tattico border border-grigio-acciaio border-opacity-30 focus:border-arancione-brand focus:border-opacity-100 text-bianco-luce outline-none transition-all font-mono"
