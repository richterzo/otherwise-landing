...
export default function About() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Non sei un numero. Qui ti alleni con persone che hanno i tuoi stessi obiettivi.',
      icon: Users,
    },
  ]
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div>
            ...
            >
              ...
              >
                DOVE L'ALLENAMENTO
                <br />
                <span className="text-bianco-luce/80">È UN RITUALE</span>
              </motion.h2>

              <motion.div
                className="space-y-4 text-bianco-luce/85 leading-relaxed"
                initial={{ opacity: 0 }}
                animate={isInView ? { opacity: 1 } : {}}
                transition={{ duration: 0.8, delay: 0.4 }}
              >
                <p>
                  Nel cuore di Ferrara, Otherwise Athletics Evolved è il luogo
                  dove il Functional Fitness incontra la disciplina, la
                  determinazione e la voglia di superarsi. Ogni workout è
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-bianco-luce/80 leading-relaxed group-hover:text-bianco-luce transition-colors">
                        {feature.description}
                      </p>
                    </div>
                  </div>
        ...
        >
          {[
            ...
            { value: '5+', label: 'COACHES', delay: 0.1 },
            ...
            >
              <motion.div
                className="text-3xl md:text-4xl font-mono font-bold text-bianco-luce mb-2 group-hover:text-arancione-brand transition-colors"
                whileHover={{ y: -5 }}
              >
                {stat.value}
              </motion.div>
              <div className="text-xs font-airborne text-bianco-luce/80 tracking-wider group-hover:text-bianco-luce transition-colors">
                {stat.label}
              </div>
