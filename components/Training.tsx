    ...
    <section id="training" className="relative py-32 bg-grigio-cemento overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 opacity-30">
        <div 
          ...
          style={{
            backgroundImage: `
              repeating-linear-gradient(0deg, rgba(42, 42, 42, 0.1) 0px, transparent 1px, transparent 2px, rgba(42, 42, 42, 0.1) 3px),
              repeating-linear-gradient(90deg, rgba(42, 42, 42, 0.1) 0px, transparent 1px, transparent 2px, rgba(42, 42, 42, 0.1) 3px),
              repeating-linear-gradient(45deg, rgba(0, 0, 0, 0.1) 0px, transparent 1px, transparent 4px, rgba(0, 0, 0, 0.1) 5px),
              repeating-linear-gradient(-45deg, rgba(0, 0, 0, 0.05) 0px, transparent 1px, transparent 8px, rgba(0, 0, 0, 0.05) 9px)
            `,
            backgroundSize: '20px 20px, 20px 20px, 40px 40px, 60px 60px',
          }}
        />
        {/* Noise texture overlay for concrete feel */}
        <div 
          className="absolute inset-0"
          style={{
